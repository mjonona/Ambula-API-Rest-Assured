...
public class LoginUserTest extends BaseTest {
    ...
    public void userLoginTest() {
        ...
        UserLoginResponseModel userLoginResponseModel = new CrudeRequesters(RequestSpecs.unAuth(), Endpoint.USER_LOGIN, ResponseSpecs.requestWasSuccess()).post(medicalID, model).extract().as(UserLoginResponseModel.class);
    ...
    public void currentMedicalCenterSetting() {
        ...
        String medicalID = Config.getProperty("medicalCenterId");
        CurrentUserResponseModel currentUserResponseModel = new CrudeRequesters(RequestSpecs.adminSpecs(), Endpoint.CURRENT_USER, ResponseSpecs.requestWasSuccess()).get(medicalID, null).extract().as(CurrentUserResponseModel.class);
